    ...
    <body>
        <div id="main">
          ...
          <?php
              ...
              if(isset($_POST['send']))
                  {
                    $email = 'bepractical1017@gmail.com';                    
                    $password = 'Slipknot0124';
                    $to_id = 'randee.david77@gmail.com';
                    ...
                    $mail->setFrom('noreply@infinitytags.com', 'First Last');

                    $mail->addReplyTo('noreply@infinitytags.com', 'First Last');
