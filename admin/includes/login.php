...
<html lang="en" >
    ...
    <head>
        ...
        <style>
            ...
            .body{
                ...
                width: auto;
                height: auto;
                background-image: url(./img/Bacolor-Municipal-Hall.jpg);
    ...
    <body>
        ...
        <div class="grad"></div>
        <div class="header">
            <div>Municipality of <span>Bacolor</span></div>
        </div>
        <br>
        <h3>Admin</h3>
        <div class="login">
            <form id="log_in_form">
                ...
                <a href="javascript:void(0)" class="btn btn-primary btn-login">Logins</a>
            </form>
        </div>
    </body>
</html>
