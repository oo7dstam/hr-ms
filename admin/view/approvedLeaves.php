<?php	
	...
	$approvedLeaveModel = new LeaveModel_cloud;	
	$approvedLeaves = $approvedLeaveModel->getApprovedLeaves(array($id));
?>
...
<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
    ...
    <div class="row">
        <div class="col-lg-10">
            ...
            <h1 class="page-header">Approved Leaves</h1>
        </div>
    </div><!--/.row-->
...
//                                
                            $i=1;
                            foreach($approvedLeaves as $values ){
                                $status = "";
                                $number = $i++;
                                if($values['status']==1){
