<?php 
	...
	if($id > 0){
		...
		if(!empty($employmentDetails)){
			$categoryDisplay = $modelCategories->getEmployeeCategories(array($employmentDetails['category_id']));
			$positionDisplay = $modelPostion->getEmployeePosition(array($employmentDetails['position_id']));
				
			$positionDetails = $modelPostion->getAllBaseOnCategoryPosition(array($employmentDetails['category_id']));
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
		<div class="row">
			<ol class="breadcrumb">
				...
				<li class="active">
					<a href="./index.php?action=addEmployee">Add Employee</a>
				</li>
			</ol>
		</div><!--/.row-->
		...
		<div class="tab-content panel panel-container">
				...
				<div class="row">
					...
					<input type="hidden" name="salary_id" value="<?php echo $salaryDetails['salary_id']; ?>"/>
...
<?php
	...
	include './modal/successSaveEmployee.php';
	include './modal/successUpdateEmployee.php';
	include './modal/errorSaveEmployee.php';
	include './modal/loading.php';
	include './script/addEmployee.php';
