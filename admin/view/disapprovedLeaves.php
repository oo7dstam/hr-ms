<?php	
	...
	$disapprovedLeaeveModel = new LeaveModel_cloud;
	$disapprovedLeaves = $disapprovedLeaeveModel->getDisapprovedLeaves(array($id));
?>
...
<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
    ...
    <div class="row">
        <div class="col-lg-10">
            ...
            <h1 class="page-header">Disapproved Leaves</h1>
        </div>
    </div><!--/.row-->
    ...
    <div class="row">
        <div class="col-sm-12">
            <table class="table table-bordered table-hover">
                ...
                <tbody>
                    <?php 
                        if(!empty($disapprovedLeaves)){
//                           
                            $i=1;
                            foreach($disapprovedLeaves as $values ){
                                $status = "";
                                $number = $i++;
