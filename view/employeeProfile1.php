...
<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
    ...
    <div class="tab-content panel panel-container">
        ...
        <div class="tab-pane active row" id="personal_tab">
            ...
            include 'view/_personalInformation.php';

            ?>
        </div><!--/.row-->
        <div class="tab-pane row" id="family_tab">
            <?php 
            include 'view/_familyBackground.php';
            include 'view/_educationBackground.php';
            ?>
        </div><!--/.row-->

        <div class="tab-pane row" id="civil_tab">
            <?php 
            include 'view/_civilServiceEligibility.php';
            include 'view/_workExperience.php';
            include 'view/_voluntaryWork.php';
            ?>
        </div><!--/.row-->
        <div class="tab-pane row" id="learning_tab">
            <?php 
            include 'view/_learningAndDevelopment.php';
            include 'view/_otherInformation.php';
            include 'view/_survey.php';
            include 'view/_references.php';
            include 'view/_governmentID.php';
            ?>
        </div><!--/.row-->
        <div class="tab-pane row" id="employment_tab">
            <?php 
            include 'view/_employmentDetails.php';
            include 'view/_salary.php';
            include 'view/_benefits.php';
            ?>
        </div><!--/.row-->
